...
import static TemplateMod.character.TemplateChar.Enums.templateColor;
import static TemplateMod.TemplateMod.*;

public class TemplateChar extends CustomPlayer {
    ...
    static final String ID = makeID("TemplateChar"); //TODO: Change this
    public static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;


    public TemplateChar(String name, PlayerClass setClass) {
    ...
    public ArrayList<String> getStartingRelics() {
        ArrayList<String> retVal = new ArrayList<>();
        retVal.add(CharacterStarterRelic.ID);
        return retVal;
    }
    ...
    public AbstractPlayer newInstance() {
        return new TemplateChar(name, chosenClass);
    }
